...
path_checkpoint = input("Enter Folder Number:")

checkpoints_dir = 'checkpoints/' + path_checkpoint # Change this path based on the output from '$ python3 train.py' script "Model saved in: checkpoints/1517781236"
